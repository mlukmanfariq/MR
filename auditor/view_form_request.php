<?php 
	...
	$user = pg_escape_string($_SESSION['auditor']);
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="panel panel-primary">
									...
									<!--<form class="form-horizontal style-form" action="" method="get"> -->										
										<div class="panel-body">
											<div class="form-group">
												<?php										
													$query = pg_query($conn, "SELECT * FROM vw_t_document_history WHERE header_id = {$header_id}");
									...
									<!--</form> -->
										&nbsp; &nbsp; &nbsp;
										<a href="index.php" class="btn btn-danger btn-xs"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Back</a>
