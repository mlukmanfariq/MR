					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php
									$nik = $_SESSION['auditor'];
									$query = pg_query($conn, "SELECT count(header_id) as notif FROM public.tbl_t_request_header where (last_step_dokumen = 0 or (last_step_dokumen > 90 and last_step_dokumen < 100))");
									...
									$query1 = pg_query($conn, "SELECT count(header_id) as notif FROM public.tbl_t_request_header where (last_step_dokumen > 0 AND last_step_dokumen < 5)");
									...
									$query3 = pg_query($conn, "SELECT count(header_id) as notif FROM public.tbl_t_request_header where last_step_dokumen = 5 and coalesce(pr_no,'') = ''");
									...
									$query4 = pg_query($conn, "SELECT count(header_id) as notif FROM public.tbl_t_request_header where last_step_dokumen = 5 and coalesce(pr_no,'') > ''");
										...
										<div class="box-body table-responsive">
											<table id="dynamic-table_detail" class="table table-bordered table-hover " cellspacing="0" width="100%">
												...
												<tbody>';
													...
													$no = 1;
													if ($last_step_dokumen == 0) {
														$query = pg_query($conn, "SELECT created_date, user_department, user_name, mr_no, purpose, header_id, last_step_dokumen, trim(step_description) as status FROM public.vw_t_approvaldocument WHERE (last_step_dokumen = 0 or (last_step_dokumen > 90 and last_step_dokumen < 100)) order by created_date desc; ");
													} else if (($last_step_dokumen == 1)) {
														$query = pg_query($conn, "SELECT created_date, user_department, user_name, mr_no, purpose, header_id, last_step_dokumen, trim(step_description) as status FROM public.vw_t_approvaldocument WHERE (last_step_dokumen > 0 and last_step_dokumen < 5) order by created_date desc; ");
													} else if ($last_step_dokumen == 5) {
														$query = pg_query($conn, "SELECT created_date, user_department, user_name, mr_no, purpose, header_id, last_step_dokumen, trim(step_description) as status FROM public.vw_t_approvaldocument WHERE last_step_dokumen = 5 and coalesce(pr_no,'') = '' order by created_date desc; ");
													} else if ($last_step_dokumen == 6) {
														$query = pg_query($conn, "SELECT created_date, user_department, user_name, mr_no, purpose, header_id, last_step_dokumen, trim(pr_no) as status FROM public.vw_t_approvaldocument WHERE last_step_dokumen = 5 and coalesce(pr_no,'') > '' order by created_date desc; ");
													}
