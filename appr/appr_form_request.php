<?php 
	...
	$header_id = pg_escape_string($_SESSION['appr_mr']);
?>
...
<html lang="en">
	...
	<body class="no-skin">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<input type="hidden" id="step_desc" name="step_desc" value="<?php echo $view['step_description'];?>" readonly/>
									...
									<!--</form> -->
									&nbsp; &nbsp; &nbsp;
									<a href="index.php?last_step_dokumen=11" class="btn btn-xs btn-warning"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Back</a>							
					  ...
					  <!-- Modal content -->
						<div class="modal-content">
							<div class="panel panel-primary">
								...
								&nbsp; &nbsp; &nbsp;<button type="button" id="approvebtn" name ="approvebtn" class="btn btn-success btn-xs" onclick="approveRow('appr')"><span class="glyphicon glyphicon-ok"></span>&nbsp; Approve</button>&nbsp; &nbsp; 
					  ...
					  <!-- Modal content -->
						<div class="modal-content">							
							<div class="panel panel-primary">
								...
								&nbsp; &nbsp; &nbsp;<button type="button" id="rejectbtn" name ="rejectbtn" class="btn btn-danger btn-xs" onclick="rejectRow()"><span class="glyphicon glyphicon-remove"></span>&nbsp; Reject</button>&nbsp; &nbsp; 
								<button type="button" id="cancel" name="cancel" class="btn btn-warning btn-xs" onclick="cancel()"><span class="glyphicon glyphicon-retweet"></span>&nbsp; Cancel</button>	
							</div>
						</div>
					</div>				
		...
		<script type="text/javascript">
			...
			function approveRow(option){
				//alert(option);
				var txt_option			= "approve";
				var txt_status_doc		= "1";
				var txt_status_desc		= "Approve by Superior";
				...
				var txt_step_desc		= $("#step_desc").val();
				...
				if (txt_remarks != ""){ //if browser doesn't support input type="date", load files for jQuery UI Date Picker
					...
					$.ajax({
						...
						success: function (result) {
								...
								alert(result);
								window.location.href = "index.php?last_step_dokumen=11";						
						},
						error: function (e) {
			...
			function rejectRow(){
				...
				var txt_status_desc		= "Reject by Superior";
			...
			function preparingOracle(){
				...
				if (txt_remarks != ""){ //if browser doesn't support input type="date", load files for jQuery UI Date Picker
					...
					$.ajax({
						...
						cache: false,
						success: function (result) {
							if (txt_step_desc == 'Waiting Approval GM') {
