	...
	<body class="no-skin">
											...
											<div class="form-group">
												...
												<table cellpadding="6" class="table table-bordered">
													<tr>
														...
														<td>:</td>
														<td>
															<input class="k-textbox textbox-custom" id="txt_section" name="txt_section" value="<?php echo $section;?>" readonly/>
														</td>

														<td >Suggested Vendor</td>
														<td>:</td>
														<td>
															<textarea rows="2" cols="40" class="k-textbox textbox-custom" id="txt_suggestedVendor" name="txt_suggestedVendor"></textarea>
														</td>
													...
													<tr>
														...
														<td>:</td>
														<td>
															<textarea rows="2" cols="40" class="k-textbox textbox-custom" id="txt_purpose" name="txt_purpose"></textarea>
														</td>
													...
													<tr>
														...
														<td>:</td>
														<td>
															<input class="k-textbox textbox-custom" id="txt_NoMR" name="txt_NoMR"  placeholder="Generate by System" readonly/>
														</td>
					  ...
					  <div class="modal-content">
						...
						<div class="panel panel-primary">
							<div class="panel-heading">Purchase Requisition Detail</div>
								...
								&nbsp; &nbsp; 
								<button type="button" id="adddata" name ="adddata" class="btn btn-success btn-xs" onclick="header()"><span class="glyphicon glyphicon-saved"></span>&nbsp; Add Row</button>&nbsp; &nbsp; 
		...
		<script type="text/javascript">
			...
			function submitDraft(){
				...
				var txt_status_desc		= "Save a Draft";
				var txt_remarks			= "Save a Draft";
				var txt_modified_date	= $("#datetime").val();
				var txt_modified_by		= $("#user").val();
