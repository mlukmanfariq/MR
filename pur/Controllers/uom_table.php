		...
		echo '
			...
			<div class="box-body table-responsive">
				<table id="dynamic-table" class="table table-bordered table-striped table-hover">
					...
					<tbody>';
						$no = 1;
						$sqlOra="SELECT a.SEGMENT1, a.PRIMARY_UNIT_OF_MEASURE, REPLACE(a.DESCRIPTION, '&', 'and') as DESCRIPTION, b.CATEGORY_ID, 
						...
						nvl(a.LEAD_TIME_LOT_SIZE,0) as LEAD_TIME_LOT_SIZE 
