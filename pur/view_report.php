								...
								<?php
									...
									<div class="box-body table-responsive">
										<table id="dynamic-table_detail" class="table table-bordered table-hover " cellspacing="0" width="100%">
											...
											<tbody>';
												$no = 1;
												$query = pg_query($conn, "SELECT created_date, mr_no, pr_no, suggested_vendor, header_id, trim(status_desc) as status, coalesce(remarks,'-') as remarks, modified_date_app FROM public.vw_t_document_history WHERE modified_by_app = '$nik' and (status_doc > 0) order by modified_date_app desc; ");
												while ($result = pg_fetch_array($query)){ echo' 
													<tr>	
														...
														<td>'.$result['modified_date_app'].'</td>
