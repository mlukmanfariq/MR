					  ...
					  <div class="modal-content">
						...
						<div class="panel panel-primary">
							<div class="panel-heading">Purchase Requisition Detail</div>
								...
								<input type = "hidden" class="k-textbox textbox-custom" id="txt_Leadtime" name="txt_Leadtime"/>
		...
		<script type="text/javascript">
				...
				$.ajax({
					...
					success: function (result) {
						...
						if (pendingItem == 0) {
							...
							{
								window.location.href = "index.php?last_step_dokumen=0";						
							} else {
								// Do nothing!
							}	
						}
			...
			function selectItem(){
				...
				table_id.onclick = function (event) {
					...
					var txt_Leadtime = document.getElementById('txt_Leadtime');
					...
					txt_Leadtime.value = cells[10].innerHTML;
			...
			function addRow(){
				...
				var txt_Leadtime		= $("#txt_Leadtime").val();
				...
				var dataString = 'itemNo='+ txt_itemNo + '&description='+ txt_Description + '&reqtQty='+ txt_ReqtQty + '&uom='+ txt_UOM 
								...
								+ '&minStock='+ txt_minStock  + '&maxStock='+ txt_maxStock  + '&stockBal='+ txt_stockBal + '&nocapex='+ txt_nocapex
								+ '&create_by='+ txt_user  + '&created_date='+ txt_date + '&headerid='+ txt_headerid + '&leadtime='+ txt_Leadtime
			...
			function editRow(){
				...
				table_id.onclick = function (event) {
					...
					var neededDate = cells[11].innerHTML;
					...
					txt_CATEGORY_ID.value = cells[13].innerHTML;
					txt_ORGANIZATION_ID.value = cells[14].innerHTML;
					txt_DESTINATION_TYPE_CODE.value = cells[15].innerHTML;
					txt_rowid.value = cells[16].innerHTML;
