<?php 
	...
	min_stock, max_stock, stock_bal, purpose, status_commit, created_date, created_by, modified_date, modified_by, category_id, organization_id, destination_type_code) 
	VALUES($next_rowid, $headerid1, $row_detail_id, '$itemNo1', '$description1', $reqtQty1, '$uom1', '$lastOrderdate1', $lastOrderQty1, '$neededDate', 
	$minStock1, $maxStock1, $stockBal1, '$purpose1', 0, '$createdDate', '$createBy', '$createdDate', '$createBy', $category_id1, $organization_id1, '$destination_type_code1');";
