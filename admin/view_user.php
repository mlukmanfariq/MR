			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<a href="user_form.php" class="btn btn-block btn-lg btn-info add">
								...
								<?php
									...
									<div class="box-body table-responsive">
										<table id="dynamic-table_detail" class="table table-bordered table-hover " cellspacing="0" width="100%">
											...
											<tbody>';
												$no = 1;
												$query = pg_query($conn, "SELECT rowid, nik, user_name, department, section, 
												CASE WHEN level = 'user_depthead' THEN 'User Approver' 
												WHEN level = 'user_pur' THEN 'User Purchasing'
												WHEN level = 'user_view' THEN 'User Requestor'  
												WHEN level = 'user' THEN 'User Creator' WHEN level = 'admin' THEN 'Admin' else level end as level, 
												md5(password) as password, 
												CASE WHEN location_id = 121 THEN 'Site/Balongan' ELSE 'HO/Jakarta' END AS location_id
												FROM public.tbl_r_general_user WHERE coalesce(active_flag,'Y') = 'Y' order by user_name; ");																						
												while ($result = pg_fetch_array($query)){ echo' 
													<tr>	
														...
														<a class="btn btn-danger btn-minier" tooltip="delete" name="delete" href="Controllers/deleterow_user.php?rowid='.$result['rowid'].'" onclick="return confirm(\'Are you sure you want to Delete this row?\');"><i class="fa fa-trash-o "></i>
															</a>
														</td>									
												</tr>';	
												$no++;
