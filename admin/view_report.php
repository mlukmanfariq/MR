								...
								<?php
									...
									<div class="box-body table-responsive">
										<table id="dynamic-table_detail" class="table table-bordered table-hover " cellspacing="0" width="100%">
											...
											<tbody>';
												$no = 1;
												$query = pg_query($conn, "SELECT created_date, user_department, user_name, mr_no, purpose, pr_no, header_id, last_step_dokumen, trim(step_description) as status FROM public.vw_t_approvaldocument order by created_date desc; ");																						
