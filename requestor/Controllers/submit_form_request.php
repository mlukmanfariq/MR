<?php 
	...
	//--------------------------------------------------------------------------------
	$query = pg_query($conn, "SELECT trim(created_by) as created_by, trim(mr_no) as mr_no, trim(purpose) as purpose, last_step_dokumen FROM tbl_t_request_header where header_id = {$headerid1}");
	...
	//--------------------------------------------------------------------------------
	$ssql1 = "SELECT next_step FROM vw_t_nextstep where header_id = {$headerid1} and decision_id = {$status_doc1}";
