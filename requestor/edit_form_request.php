							...
							<div class="col-xs-12">
								<div class="panel panel-primary">
													...
													<div class="box-body table-responsive">
														<table id="dynamic-table_detail" class="table table-bordered table-hover " cellspacing="0" width="100%">
															...
															<tbody>';
																if($cek_row > 0){
																	$no = 1;
																	$query = pg_query($conn, "SELECT * FROM vw_t_requestall where header_id = {$header_id}  and created_by = '{$user}' ORDER BY row_detail_id");
																	while ($result = pg_fetch_array($query)){ echo' 
																		<tr>	
																			...
																			<td><center>
																				...
																				<a class="btn btn-danger btn-minier" name="delete" href="Controllers/deleterow.php?rowidEdit='.$result['rowid'].'" onclick="return confirm(\'Are you sure you want to Delete this row?\');">
									...
									<!--</form> -->
										...
										&nbsp; &nbsp; &nbsp;
										<button id="cancel" name="clear" class="btn btn-default btn-sm" onclick="cancelInsert()">Cancel Request</button>																		
		...
		<script type="text/javascript">
			...
			function selectItem(){
				...
				table_id.onclick = function (event) {
					...
					var txt_stockBal = document.getElementById('txt_stockBal');
					var txt_nocapex = document.getElementById('txt_nocapex');
