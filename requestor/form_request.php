											...
											<div class="form-group">
												...
												<table cellpadding="6" class="table table-bordered">
													<tr>
														...
														<td>:</td>
														<td>
															<textarea rows="2" cols="40" class="k-textbox textbox-custom" id="txt_suggestedVendor" name="txt_suggestedVendor" maxlength="239"></textarea>
														</td>
													...
													<tr>
														...
														<td>:</td>
														<td class="control-group danger">
															<textarea rows="2" cols="40" class="k-textbox textbox-custom" id="txt_purpose" name="txt_purpose" maxlength="239"></textarea>
														</td>
							...
							<div class="panel-heading">Purchase Requisition Detail</div>
								...
								<table cellpadding="6" class="table table-bordered">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input class="k-textbox textbox-custom" id="txt_balance" name="txt_balancece" maxlength="50" readonly="" />	
										</td>
									</tr>
									<tr>
										<td></td>
		...
		<script type="text/javascript">
			...
			function search(){				
				$.ajax({
					...
					data: {
						description1: $("#txt_Description").val().replace("'", "*")
					},
					cache: false,
			...
			function header(){
				...
				var txt_suggestedVendor	= $("#txt_suggestedVendor").val().replace("'", "*");
				var txt_NoPR 			= $("#txt_NoPR").val();
				var txt_purpose 		= $("#txt_purpose").val().replace("'", "*");
				...
				if ((txt_Requestor != "") && (txt_purpose != "")){
					if ((txt_Description != "") && (txt_ReqtQty > 0)) {
						$.ajax({
							type: 'POST',
						...
						alert("Field Desc of Material or Req Qty still Empty!!!");
					}					
				} else {
