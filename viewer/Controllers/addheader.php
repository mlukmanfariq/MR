<?php 
	...
	pr_no, requestor_id, created_date, created_by, modified_date, modified_by, last_step_dokumen) 
	VALUES ($header_id, '$mrno', '$usersection', '$userdepartment', '$costCenter', '$suggestedVendor', 
	'$prNo', $requestorID, '$createdDate', '$createBy', '$createdDate', '$createBy', 0);
