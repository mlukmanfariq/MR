<?php 
	...
	$user = pg_escape_string($_SESSION['user_view']);
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="panel panel-primary">
									...
									<!--<form class="form-horizontal style-form" action="" method="get"> -->										
										<div class="panel-body">
											<div class="form-group">
												<?php										
													$query = pg_query($conn, "SELECT * FROM vw_t_document_history WHERE header_id = {$header_id} and requestor_id = $id_code");
									...
									<!--</form> -->
										&nbsp; &nbsp; &nbsp;
										<a href="index.php?last_step_dokumen=0" class="btn btn-danger btn-xs"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Back</a>
